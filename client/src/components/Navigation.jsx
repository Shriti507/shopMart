    ...
    <header className="w-full bg-white border-b border-gray-100 shadow-sm transition-all duration-300">
      <div className="max-w-[1400px] mx-auto px-8 xl:px-12 py-5 flex justify-between items-center">
        ...
        <nav className="hidden lg:flex items-center gap-10 text-[13px] font-bold tracking-widest uppercase">
          <Link to="/" className={`${location.pathname === '/' ? 'text-[#dac889] border-b-2 border-[#dac889] pb-1.5' : 'text-gray-500 hover:text-[#dac889]'} transition-all`}>Home</Link>
          <Link to="/services" className={`${location.pathname === '/services' ? 'text-[#dac889] border-b-2 border-[#dac889] pb-1.5' : 'text-gray-500 hover:text-[#dac889]'} transition-all`}>Services</Link>
          <Link to="/about" className={`${location.pathname === '/about' ? 'text-[#dac889] border-b-2 border-[#dac889] pb-1.5' : 'text-gray-500 hover:text-[#dac889]'} transition-all`}>About Us</Link>
          <Link to="/categories" className={`${location.pathname === '/categories' ? 'text-[#dac889] border-b-2 border-[#dac889] pb-1.5' : 'text-gray-500 hover:text-[#dac889]'} transition-all`}>Categories</Link>
          <Link to="/contact" className={`${location.pathname === '/contact' ? 'text-[#dac889] border-b-2 border-[#dac889] pb-1.5' : 'text-gray-500 hover:text-[#dac889]'} transition-all`}>Contact</Link>
        </nav>
        ...
        <div className="flex items-center gap-6">
          ...
          <div className="w-px h-8 bg-gray-200 hidden md:block"></div> {/* Divider */}
