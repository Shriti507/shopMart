      ...
      <div className="relative max-w-7xl mx-auto px-4 py-16 md:py-24 flex flex-col md:flex-row items-center gap-12">
        ...
        <div className="w-full md:w-1/2 flex flex-col items-start z-10">
          ...
          <div className="flex items-center gap-2 bg-white/10 backdrop-blur-sm px-4 py-2 rounded-full mb-6 border border-white/20">
            ...
            <span className="text-sm text-gray-200">Grocery Delivery Service</span>
          </div>

          
          <h1 className="text-5xl md:text-7xl font-bold leading-tight mb-8">
            Get fresh <span className="text-white">Grocery</span><br/>
            <span className="text-gray-200 font-normal">Enjoy healthy life.</span>
          </h1>
          ...
          <div className="w-full max-w-md flex flex-col sm:flex-row items-center bg-[#2c3725]/80 backdrop-blur-md rounded-full mb-4 border border-white/10 p-1">
            <div className="flex-1 flex items-center justify-between px-6 py-2 w-full sm:w-auto overflow-hidden">
              <span className="text-gray-300 text-sm whitespace-nowrap">Select Category</span>
          ...
          <p className="text-gray-400 text-sm mb-12 pl-2">
            Not yet Member? <Link to="/signUp" className="text-[#dac889] hover:underline">Sign Up</Link> Now
          </p>
          ...
          <div className="flex flex-col xl:flex-row gap-8 items-start xl:items-center w-full mt-4">
            ...
            <div className="flex items-center gap-5 bg-[#252f1e]/80 backdrop-blur-md border border-white/5 px-6 py-5 rounded-2xl shadow-xl w-fit shrink-0">
              <div className="flex -space-x-3 shrink-0">
                <img src="https://i.pravatar.cc/100?img=1" alt="Customer" className="w-12 h-12 rounded-full border-2 border-[#252f1e]" />
                <img src="https://i.pravatar.cc/100?img=3" alt="Customer" className="w-12 h-12 rounded-full border-2 border-[#252f1e]" />
                <img src="https://i.pravatar.cc/100?img=5" alt="Customer" className="w-12 h-12 rounded-full border-2 border-[#252f1e]" />
              </div>
              <div className="flex flex-col shrink-0 min-w-max">
                ...
                <div className="flex items-center gap-2 mt-0.5">
                  <div className="flex items-center font-bold text-base text-white">
                    <Star size={16} className="fill-[#dac889] text-[#dac889] mr-1" />
                    4.5
                  </div>
            ...
            <div className="flex flex-col relative z-20">
              <span className="text-[15px] font-bold mb-3 text-white">Download App</span>
              <div className="flex flex-col sm:flex-row gap-4">
                <button className="flex items-center justify-center gap-3 bg-[#131412] hover:bg-black text-white px-5 py-2.5 rounded-xl transition-all border border-white/10 shadow-lg min-w-[170px]">
                  ...
                  <div className="flex flex-col items-start leading-tight">
                    <span className="text-[10px] text-gray-300 tracking-wide font-medium">GET IT ON</span>
                    <span className="text-base font-semibold font-sans tracking-tight">Google Play</span>
                  </div>
                </button>
                <button className="flex items-center justify-center gap-3 bg-[#131412] hover:bg-black text-white px-5 py-2.5 rounded-xl transition-all border border-white/10 shadow-lg min-w-[170px]">
                
                  <svg viewBox="0 0 384 512" width="28" height="28" xmlns="http://www.w3.org/2000/svg">
                  ...
                  <div className="flex flex-col items-start leading-tight">
                    <span className="text-[10px] text-gray-300 tracking-wide font-medium">Download on the</span>
                    <span className="text-base font-semibold font-sans tracking-tight">App Store</span>
                  </div>
                </button>
              </div>
            </div>
