      ...
      <div className="max-w-[1400px] mx-auto">
        ...
        <div className="relative rounded-[24px] overflow-hidden mb-24 group shadow-[0_20px_60px_rgba(0,0,0,0.1)] transition-transform duration-500 hover:scale-[1.01]">
          ...
          <div className="relative z-10 p-12 md:p-20 flex flex-col lg:flex-row items-center justify-between gap-12">
            <div className="max-w-xl text-center lg:text-left">
              <h3 className="text-4xl md:text-5xl font-black text-[#111827] mb-6 tracking-tighter leading-tight uppercase">STAY FRESH WITH <br/><span className="text-[#2a3622]">SHOPSMART UPDATES</span></h3>
              <p className="text-[#4B5563] font-medium text-lg leading-relaxed">Join 50,000+ happy shoppers and get exclusive deals delivered weekly.</p>
            </div>
            ...
            <div className="w-full lg:w-max flex flex-col sm:flex-row gap-4 bg-gray-50 p-2 rounded-[28px] border border-gray-100 shadow-sm transition-all hover:shadow-md">
              <div className="relative flex-1 min-w-[320px]">
                <Mail className="absolute left-5 top-1/2 -translate-y-1/2 text-gray-500" size={22} />
                <input 
                  type="email" 
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-12 mb-20 pb-20 border-b border-black/[0.03]">
          <div className="flex items-center gap-6 group">
            ...
            <div>
              <h4 className="text-[#111827] font-black text-lg leading-tight uppercase tracking-wide">Fast Delivery</h4>
              <p className="text-xs mt-1 font-bold text-[#9CA3AF]">Free over $50</p>
            </div>
          </div>
          <div className="flex items-center gap-6 group">
            <div className="w-16 h-16 rounded-2xl bg-white flex items-center justify-center text-[#1b2316] group-hover:bg-[#1b2316] group-hover:text-white transition-all duration-500 shadow-sm border border-gray-100">
            ...
            <div>
              <h4 className="text-[#111827] font-black text-lg leading-tight uppercase tracking-wide">Easy Returns</h4>
              <p className="text-xs mt-1 font-bold text-[#9CA3AF]">30 days policy</p>
            </div>
          </div>
          <div className="flex items-center gap-6 group">
            <div className="w-16 h-16 rounded-2xl bg-white flex items-center justify-center text-[#1b2316] group-hover:bg-[#1b2316] group-hover:text-white transition-all duration-500 shadow-sm border border-gray-100">
            ...
            <div>
              <h4 className="text-[#111827] font-black text-lg leading-tight uppercase tracking-wide">Secure Pay</h4>
              <p className="text-xs mt-1 font-bold text-[#9CA3AF]">100% Protected</p>
            </div>
          </div>
          <div className="flex items-center gap-6 group">
            <div className="w-16 h-16 rounded-2xl bg-white flex items-center justify-center text-[#1b2316] group-hover:bg-[#1b2316] group-hover:text-white transition-all duration-500 shadow-sm border border-gray-100">
            ...
            <div>
              <h4 className="text-[#111827] font-black text-lg leading-tight uppercase tracking-wide">VIP Deals</h4>
              <p className="text-xs mt-1 font-bold text-[#9CA3AF]">Exclusive Offers</p>
            </div>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-20 mb-20">
          <div className="lg:col-span-2">
            ...
            <p className="max-w-sm text-[#4B5563] font-medium leading-relaxed mb-10 text-sm">
              Experience the future of grocery shopping. Premium quality, farm-fresh produce delivered with lightning speed.
            </p>
            <div className="flex items-center gap-5">
              <a href="#" className="w-12 h-12 rounded-2xl bg-white flex items-center justify-center text-[#4B5563] hover:bg-[#D4AF37] hover:text-white transition-all duration-300 shadow-sm border border-gray-100">
                <Instagram size={20} />
              </a>
              <a href="#" className="w-12 h-12 rounded-2xl bg-white flex items-center justify-center text-[#4B5563] hover:bg-[#1b2316] hover:text-white transition-all duration-300 shadow-sm border border-gray-100">
                <Facebook size={20} />
              </a>
              <a href="#" className="w-12 h-12 rounded-2xl bg-white flex items-center justify-center text-[#4B5563] hover:bg-[#1b2316] hover:text-white transition-all duration-300 shadow-sm border border-gray-100">
                <Twitter size={20} />
          ...
          <div>
            ...
            <ul className="flex flex-col gap-5 text-[#1b2316] font-bold text-sm">
              <li><Link to="/vegetables" className="hover:text-[#D4AF37] hover:underline transition-all duration-300">Vegetables</Link></li>
              <li><Link to="/beverages" className="hover:text-[#D4AF37] hover:underline transition-all duration-300">Beverages</Link></li>
              <li><Link to="/meat" className="hover:text-[#D4AF37] hover:underline transition-all duration-300">Meats</Link></li>
              <li><Link to="/frozen" className="hover:text-[#D4AF37] hover:underline transition-all duration-300">Frozen</Link></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="flex flex-col gap-5 text-[#1b2316] font-bold text-sm">
              <li><a href="#" className="hover:text-[#D4AF37] hover:underline transition-all duration-300">Help Center</a></li>
              <li><a href="#" className="hover:text-[#D4AF37] hover:underline transition-all duration-300">Returns</a></li>
              <li><a href="#" className="hover:text-[#D4AF37] hover:underline transition-all duration-300">Privacy</a></li>
              <li><a href="#" className="hover:text-[#D4AF37] hover:underline transition-all duration-300">Terms</a></li>
            </ul>
          </div>
        ...
        <div className="py-12 border-t border-black/[0.05] flex flex-col md:flex-row items-center justify-between gap-6">
          <p className="text-xs font-bold text-[#9CA3AF] uppercase tracking-widest">
            © {new Date().getFullYear()} <span className="text-[#1b2316]">ShopSmart</span> Inc. All rights reserved.
          </p>
          <div className="flex items-center gap-8 text-[10px] font-black uppercase tracking-[0.2em] text-[#9CA3AF]">
            <a href="#" className="hover:text-[#1b2316] transition-colors">Terms</a>
            <a href="#" className="hover:text-[#1b2316] transition-colors">Privacy</a>
            <a href="#" className="hover:text-[#1b2316] transition-colors">Cookies</a>
          </div>
