    ...
    <div className="w-full bg-gray-50 flex flex-col flex-grow">
      ...
      <main className="flex-grow max-w-7xl mx-auto w-full px-4 py-6 md:py-10">
        <div className="flex items-center gap-2 mb-8">
          <Link
            to="/user-dashboard"
            className="text-gray-500 hover:text-[#1b2316] transition-colors flex items-center gap-1 font-bold text-sm"
          >
        ...
        <div className="flex flex-col lg:flex-row gap-6">
          <div className="flex-1">
            ...
            {loading ? (
              <div className="flex flex-col items-center justify-center py-20 bg-white rounded-3xl border border-gray-100 shadow-sm">
                ...
                <p className="mt-4 text-gray-500 font-bold tracking-wide">
              ...
              <div className="flex flex-col items-center justify-center py-24 bg-white rounded-3xl border border-gray-200 shadow-[0_10px_40px_rgba(0,0,0,0.02)]">
                ...
                <h2 className="text-2xl font-bold text-[#1b2316] mb-3">
                  Your cart is empty
                </h2>
                ...
                <Link
                  to="/user-dashboard"
                  className="bg-[#1b2316] text-white px-10 py-4 rounded-2xl font-black text-sm tracking-widest hover:opacity-90 transition-all shadow-lg hover:-translate-y-1 uppercase"
                >
                  Start Shopping
                </Link>
              </div>
              ...
              <div className="flex flex-col gap-4">
                {items.map((item) => (
                  <div
                    key={item.productId}
                    className="bg-white rounded-2xl p-4 sm:p-6 border border-gray-100 shadow-sm flex flex-col sm:flex-row items-center gap-6 group hover:border-[#dac889]/30 transition-all"
                  >
                    ...
                    <div className="flex-1 flex flex-col gap-1 w-full text-center sm:text-left">
                      <h3 className="text-lg font-black text-[#1b2316] leading-snug">
                        {item.title}
                      </h3>
                      ...
                      <div className="mt-3 flex items-center justify-center sm:justify-start gap-4">
                        <div className="flex items-center bg-gray-50 border border-gray-100 rounded-xl px-1">
                          ...
                          <span className="w-8 text-center font-black text-sm text-[#1b2316]">
                            {item.quantity}
                          </span>
                          <button
                            onClick={() =>
          ...
          <div className="w-full lg:w-[380px]">
            <div className="bg-white rounded-3xl p-8 border border-gray-200 shadow-[0_10px_40px_rgba(0,0,0,0.02)] sticky top-32">
              <h3 className="text-xl font-black text-[#1b2316] mb-6">
                Order Summary
              </h3>
              ...
              <div className="flex flex-col gap-4 mb-8">
                ...
                <div className="flex justify-between items-center text-gray-500 font-bold text-sm">
                  <span className="flex items-center gap-2">
                    Shipping{" "}
                    {totalPrice > 50 && (
                      <span className="text-xs bg-green-100 text-green-600 px-2 py-0.5 rounded-full font-black uppercase">
                        Free
                      </span>
                    )}
                  </span>
                ...
                <div className="flex justify-between items-center">
                  <span className="text-lg font-black text-[#1b2316]">
                    Total
                  </span>
                  <span className="text-2xl font-black text-[#dac889]">
            ...
            {totalPrice < 50 && items.length > 0 && (
              <div className="mt-4 p-4 bg-[#dac889]/10 border border-[#dac889]/20 rounded-2xl">
                <p className="text-[#847949] text-xs font-bold leading-relaxed text-center">
                  Add{" "}
                  <span className="font-black text-[#6d633b]">
                    {formatUSD(50 - subtotal)}
                  </span>{" "}
