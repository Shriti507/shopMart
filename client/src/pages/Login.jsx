  ...
  return (
    <div className="flex h-screen w-full">
            <div className="w-[55%] hidden md:inline-block">
                <img className="h-full w-full object-cover" src={groceryImage} alt="leftSideImage" />
            </div>
            ...
            <div className="w-full  md:w-[45%] flex flex-col items-center justify-center md:items-start md:pl-24">
                ...
                <form className="md:w-96 w-80 flex flex-col  justify-center">
                    ...
                    <p className="text-sm text-[#839490] mt-3">Welcome back! Please sign in to continue</p>
                    ...
                    <div className="flex items-center gap-4 w-full my-5">
                        ...
                        <p className="w-full text-nowrap text-sm text-[#839490]">or sign in with email</p>
                        <div className="w-full h-px bg-gray-300/90"></div>
                    </div>
                    ...
                    <div className="w-full flex items-center justify-between mt-8 text-[#839490]">
