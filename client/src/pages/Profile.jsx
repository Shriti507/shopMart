...
import { User, ChevronRight, MapPin, ShoppingBag, Pill, Gift, ShieldCheck, LogOut } from "lucide-react";
      ...
      <div className="max-w-[600px] mx-auto px-4 py-8">
        ...
        <div className="bg-white rounded-[24px] p-6 shadow-sm border border-gray-100 flex items-center gap-4 mb-6">
          ...
          <div className="flex-1">
            <h1 className="text-xl font-bold text-[#1a1a1a]">{user?.name || "Guest User"}</h1>
            <p className="text-[#6b7280] text-sm">{user?.phone || "No phone added"}</p>
          </div>
          <button 
        ...
        <div className="bg-white rounded-[24px] shadow-sm border border-gray-100 overflow-hidden">
          ...
          >
            ...
            <div className="text-left">
              ...
              <p className="text-[#6b7280] text-xs font-medium">Sign out from your account</p>
            </div>
