...
import { ShoppingCart, LayoutGrid, Heart, Star, ChevronRight } from 'lucide-react';
  ...
  const categories = [
    {
      ...
      image: "https://images.unsplash.com/photo-1566385101042-1a000c1268c4?auto=format&fit=crop&q=80&w=800",
      count: "120+ Items"
    },
    {
    ...
    {
      title: "Beverages",
      image: "https://images.unsplash.com/photo-1625772299847-2c1b7405ba8c?auto=format&fit=crop&q=80&w=800",
      count: "110+ Items"
    }
  ];
        ...
        <div className="max-w-[1400px] mx-auto px-8 xl:px-12 relative z-10">
          <div className="text-center mb-20 max-w-3xl mx-auto">
            ...
            <p className="text-xl text-gray-400 font-medium leading-relaxed">
              Explore our wide selection of premium groceries, carefully curated for you.
            </p>
          </div>

          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-10">
            {categories.map((category, index) => (
              <div key={index} className="group relative overflow-hidden rounded-[40px] shadow-[0_20px_50px_rgba(0,0,0,0.3)] bg-[#171e13] border border-white/5 transition-all duration-500 hover:-translate-y-2">
                ...
                <div className="p-8 relative z-10 flex items-center justify-between">
                  <div>
                    <h3 className="text-2xl font-black text-white mb-2 uppercase tracking-tight">{category.title}</h3>
                    <p className="text-[#D4AF37] text-xs font-black uppercase tracking-widest">{category.count}</p>
                  </div>
