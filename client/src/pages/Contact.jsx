              ...
              <form onSubmit={handleSubmit} className="space-y-10">
                <div className="grid md:grid-cols-2 gap-10">
                  <div className="space-y-4">
                    ...
                    <div
                      className={`relative bg-[#111827] border ${errors.name ? "border-red-500/50" : "border-white/10"} rounded-xl overflow-hidden focus-within:border-[#D4AF37] transition-all duration-300`}
                    >
                      <input
                        type="text"
                        id="name"
                    ...
                    {errors.name && (
                      <p className="text-red-400 text-xs font-medium mt-2 ml-1 flex items-center gap-1.5">
                  ...
                  <div className="space-y-4">
                    ...
                    <div
                      className={`relative bg-[#111827] border ${errors.email ? "border-red-500/50" : "border-white/10"} rounded-xl overflow-hidden focus-within:border-[#D4AF37] transition-all duration-300`}
                    >
                      <input
                        type="email"
                        id="email"
                ...
                <div className="space-y-4">
                  ...
                  <div
                    className={`relative bg-[#111827] border ${errors.message ? "border-red-500/50" : "border-white/10"} rounded-xl overflow-hidden focus-within:border-[#D4AF37] transition-all duration-300`}
                  >
                    <textarea
                      id="message"
                      name="message"
