...
export default class UserController {
  ...
  public getProfile = async (
    req: AuthRequest<Record<string, never>, unknown, unknown>,
    res: Response,
  ): Promise<Response> => {
    try {
      if (!req.userId) {
  ...
  public updateProfile = async (
    ...
    try {
      ...
      const user = await this.userService.updateProfile(req.userId, {
        name,
        phone,
      });
  ...
  public addAddress = async (
    req: AuthRequest<Record<string, never>, unknown, Address>,
    res: Response,
  ): Promise<Response> => {
    try {
      if (!req.userId) {
  ...
  public updateAddress = async (
    req: AuthRequest<Params, unknown, Partial<Address>>,
    res: Response,
  ): Promise<Response> => {
    try {
      if (!req.userId) {
  ...
  public deleteAddress = async (
    req: AuthRequest<Params, unknown, unknown>,
    res: Response,
  ): Promise<Response> => {
    try {
      if (!req.userId) {
